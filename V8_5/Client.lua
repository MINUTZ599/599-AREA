...
local c={}
for i=0,9 do
 local ok,s=pcall(function() return game:HttpGet(base..string.format("chunk_%02d.lua",i)) end)
 if not ok or type(s)~="string" then return fail("base download failed at chunk "..i) end
